...
\v{zn}{m} &:= \max\Bigg(\Big(\sum_{k=1}^K \v{Z}{km}^2\Big)^{1/2},\ \exp(-15)\Bigg),\quad \v{zn}\in\mathbb{R}^M \\
...
\v{yn}_i &:= \max\Bigg(\Big(\sum_{m=1}^M \v{Y}{bm}^2\Big)^{1/2}\ , \exp(-15) \Bigg),\quad \v{yn}\equiv(\v{yn}_i)_{i=1}^B \\
...
\\
\ddfrac{\v{zn}{m}}{\v{Z}{km}} &= \begin{cases}\frac{\v{Z}{km}}{\v{zn}{m}},\quad &\text{if}\ \v{zn}{m} > \exp(-15) \\ 0,\quad &\text{otherwise} \end{cases} \\
\ddfrac{\v{P}{bm}}{\v{Z}{km}} &= \tfrac12(\ev{b}{m}+\ev{-b}{m})\,\sqrt{c}\,\lam_b\,
\Big(\v{X}{bk}\,\v{zn}{m}^{-1} - \v{XZ}{bm}\,\v{zn}{m}^{-2}\,\ddfrac{\v{zn}{m}}{\v{Z}{km}}\Big).
\end{align}
Define:

\begin{align}
  \T{7}{bm} &:= \begin{cases}
  \T{6}{bm}\,\v{zn}{m}^{-1}\left( 2\,\log\left(\v{P}{bm} + \sqrt{\v{P}{bm}^2 + 1}\right) - \frac{(\ev{b} + \ev{-b})\,\sqrt{c}\,\lam_b\,\v{XZ}{bm}\,\v{zn}{m}^{-1}}{\sqrt{\v{P}{bm}^2 + 1}}\right),\quad &\text{if}\, \v{zn}{m} > \exp(-15) \\
  0,\quad & \text{otherwise} 
  \end{cases}\\
  \T{8}{bm} &:= \T{6}{bm}\,\frac{(\ev{b} + \ev{-b})\,\sqrt{c}\,\lam_b}{\sqrt{\v{P}{bm}^2 + 1}}
\end{align}
Collecting:
\begin{align}
\ddfrac{\mathcal{L}}{\v{Z}{km}} = \sum_b \Big(\v{Z}{km}\,\T{7}{bm} + \v{X}{bk}\,\T{8}{bm}\Big),
\quad
\boxed{\ \ddfrac{\mathcal{L}}{\v{Z}} = \v{Z}\,\odot\,\colnorm{\T{7}}\ +\ \v{X}^\top \T{8}\ }\in\mathbb{R}^{K\times M}.
\end{align}
...
\end{align}
since $\v{b}=2\sqrt{c}\,\v{r}$. 
Then
\[
\ddfrac{\mathcal{L}}{\v{r}{m}}
= \sum_b \underbrace{\T{6}{bm}\,\frac{\sqrt{c}\,\v{zn}{m}}{\sqrt{\v{P}{bm}^2+1}} \Big[(\ev{b}{m}-\ev{-b}{m})\,\frac{c\,\lam_b}{\v{zn}{m}}
+ (\ev{b}{m}+\ev{-b}{m})\,(\lam_b-1)\Big]}_{:=\T{9}{bm}}
\]
\[
\boxed{\ \ddfrac{\mathcal{L}}{\v{r}} = \sum_b \T{9}{b}}
\]
