...
Collecting:
\begin{align}
\ddfrac{\mathcal{L}}{\v{Z}{km}} =& \sum_b \Bigg[\v{Z}{km}\,\underbrace{\T{6}{bm}\,\v{zn}{m}^{-1}\left( 2\,\log\left(\v{P}{bm} + \sqrt{\v{P}{bm}^2 + 1}\right) - \frac{(\ev{b} + \ev{-b})\,\sqrt{c}\,\lam_b\,\v{XZ}{bm}\,\v{zn}{m}^{-1}}{\sqrt{\v{P}{bm}^2 + 1}}\right)}_{:=\T{7}{bm}} + \\
& + \v{X}{bk}\,\underbrace{\T{6}{bm}\,\frac{(\ev{b} + \ev{-b})\,\sqrt{c}\,\lam_b}{\sqrt{\v{P}{bm}^2 + 1}}}_{:=\T{8}{bm}}\Bigg] \\
\end{align}
Then
\[
\ddfrac{\mathcal{L}}{\v{Z}{km}}
= \sum_b \Big[\T{7}{bm}\,\v{Z}{km} + \T{8}{bm}\,\v{X}{bk}\Big],
\quad
